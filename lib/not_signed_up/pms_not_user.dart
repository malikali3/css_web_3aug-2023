...
import 'package:new_css_web/not_signed_up/show_pms_tiles.dart';
...
class pms_subjects_not_user extends StatefulWidget {
  const pms_subjects_not_user({super.key});

  @override
  State<pms_subjects_not_user> createState() => _pms_subjects_not_user();

}

final isDialOpen = ValueNotifier(false);
class _pms_subjects_not_user extends State<pms_subjects_not_user> {
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        if(index== 0){
                          return Align(
                            child: showPmsTiles(subjectTitle: compulsoryPMS[index]['title'], subjectMarks: compulsoryPMS[index]['marks'].toString(), subjectCode: compulsoryPMS[index]['code'],
                            ),
                          );
                        };
                        if(index== 1){
                          return showPmsTiles(subjectTitle: compulsoryPMS[index]["title"], subjectMarks: compulsoryPMS[index]['marks'].toString(), subjectCode: compulsoryPMS[index]['code'],);
                        };
                        if(index== 2){
                          return showPmsTiles(subjectTitle: compulsoryPMS[index]["title"], subjectMarks: compulsoryPMS[index]['marks'].toString(), subjectCode: compulsoryPMS[index]['code'],);
                        };
                  ...
                  SizedBox(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        if(index== 0){
                          return showPmsTiles(subjectTitle: ogA[index]['title'], subjectMarks: ogA[index]['marks'].toString(), subjectCode: ogA[index]['code'],);
                        };
                        if(index== 1){
                          return showPmsTiles(subjectTitle: ogA[index]["title"], subjectMarks: ogA[index]['marks'].toString(), subjectCode: ogA[index]['code'],);
                        };
                  ...
                  SizedBox(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        if(index== 0){
                          return showPmsTiles(subjectTitle: ogB[index]['title'], subjectMarks: ogB[index]['marks'].toString(), subjectCode: ogB[index]['code'],);
                        };
                        if(index== 1){
                          return showPmsTiles(subjectTitle: ogB[index]["title"], subjectMarks: ogB[index]['marks'].toString(), subjectCode: ogB[index]['code'],);
                        };
                  ...
                  SizedBox(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        if(index== 0){
                          return showPmsTiles(subjectTitle: ogC[index]['title'], subjectMarks: ogC[index]['marks'].toString(), subjectCode: ogC[index]['code'],);
                        };
                        if(index== 1){
                          return showPmsTiles(subjectTitle: ogC[index]["title"], subjectMarks: ogC[index]['marks'].toString(), subjectCode: ogC[index]['code'],);
                        };
                  ...
                  SizedBox(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        if(index== 0){
                          return showPmsTiles(subjectTitle: ogD[index]['title'], subjectMarks: ogD[index]['marks'].toString(), subjectCode: ogD[index]['code'],);
                        };
                        if(index== 1){
                          return showPmsTiles(subjectTitle: ogD[index]["title"], subjectMarks: ogD[index]['marks'].toString(), subjectCode: ogD[index]['code'],);
                        };
                  ...
                  SizedBox(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        if(index== 0){
                          return showPmsTiles(subjectTitle: ogE[index]['title'], subjectMarks: ogE[index]['marks'].toString(), subjectCode: ogE[index]['code'],);
                        };
                        if(index== 1){
                          return showPmsTiles(subjectTitle: ogE[index]["title"], subjectMarks: ogE[index]['marks'].toString(), subjectCode: ogE[index]['code'],);
                        };
                  ...
                  SizedBox(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        // Return a widget for each grid item
                        if(index== 0){
                          return showPmsTiles(subjectTitle: ogF[index]['title'], subjectMarks: ogF[index]['marks'].toString(), subjectCode: ogF[index]['code'],);
                        };
                        if(index== 1){
                          return showPmsTiles(subjectTitle: ogF[index]["title"], subjectMarks: ogF[index]['marks'].toString(), subjectCode: ogF[index]['code'],);
                        };
                  ...
                  SizedBox(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        if(index== 0){
                          return showPmsTiles(subjectTitle: ogG[index]['title'], subjectMarks: ogG[index]['marks'].toString(), subjectCode: ogG[index]['code'],);
                        };
                        if(index== 1){
                          return showPmsTiles(subjectTitle: ogG[index]["title"], subjectMarks: ogG[index]['marks'].toString(), subjectCode: ogG[index]['code'],);
                        };
