...
class css_subjects_not_user extends StatefulWidget {
  const css_subjects_not_user({super.key});

  @override
  State<css_subjects_not_user> createState() => _css_subjects_not_userState();

}

final isDialOpen = ValueNotifier(false);
class _css_subjects_not_userState extends State<css_subjects_not_user> {
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        if(index== 0){
                          return showCssTiles(subjectTitle: compulsory[index]['title'], subjectMarks: compulsory[index]['marks'].toString(), subjectCode: compulsory[index]['code'],
                          );
                        };
                        if(index== 1){
                          return showCssTiles(subjectTitle: compulsory[index]["title"], subjectMarks: compulsory[index]['marks'].toString(), subjectCode: compulsory[index]['code'],);
                  ...
                  SizedBox(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        if(index== 0){
                          return showCssTiles(subjectTitle: og1[index]['title'], subjectMarks: og1[index]['marks'].toString(), subjectCode: og1[index]['code'],);
                        };
                        if(index== 1){
                          return showCssTiles(subjectTitle: og1[index]["title"], subjectMarks: og1[index]['marks'].toString(), subjectCode: og1[index]['code'],);
                        };
                  ...
                  SizedBox(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        if(index== 0){
                          return showCssTiles(subjectTitle: og2[index]['title'], subjectMarks: og2[index]['marks'].toString(), subjectCode: og2[index]['code'],);
                        };
                        if(index== 1){
                          return showCssTiles(subjectTitle: og2[index]["title"], subjectMarks: og2[index]['marks'].toString(), subjectCode: og2[index]['code'],);
                        };
                  ...
                  SizedBox(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        if(index== 0){
                          return showCssTiles(subjectTitle: og3[index]['title'], subjectMarks: og3[index]['marks'].toString(), subjectCode: og3[index]['code'],);
                        };
                        if(index== 1){
                          return showCssTiles(subjectTitle: og3[index]["title"], subjectMarks: og3[index]['marks'].toString(), subjectCode: og3[index]['code'],);
                        };
                  ...
                  SizedBox(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        if(index== 0){
                          return showCssTiles(subjectTitle: og4[index]['title'], subjectMarks: og4[index]['marks'].toString(), subjectCode: og4[index]['code'],);
                        };
                        if(index== 1){
                          return showCssTiles(subjectTitle: og4[index]["title"], subjectMarks: og4[index]['marks'].toString(), subjectCode: og4[index]['code'],);
                        };
                  ...
                  SizedBox(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        if(index== 0){
                          return showCssTiles(subjectTitle: og5[index]['title'], subjectMarks: og5[index]['marks'].toString(), subjectCode: og5[index]['code'],);
                        };
                        if(index== 1){
                          return showCssTiles(subjectTitle: og5[index]["title"], subjectMarks: og5[index]['marks'].toString(), subjectCode: og5[index]['code'],);
                        };
                  ...
                  SizedBox(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        // Return a widget for each grid item
                        if(index== 0){
                          return showCssTiles(subjectTitle: og6[index]['title'], subjectMarks: og6[index]['marks'].toString(), subjectCode: og6[index]['code'],);
                        };
                        if(index== 1){
                          return showCssTiles(subjectTitle: og6[index]["title"], subjectMarks: og6[index]['marks'].toString(), subjectCode: og6[index]['code'],);
                        };
                  ...
                  SizedBox(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        if(index== 0){
                          return showCssTiles(subjectTitle: og7[index]['title'], subjectMarks: og7[index]['marks'].toString(), subjectCode: og7[index]['code'],);
                        };
                        if(index== 1){
                          return showCssTiles(subjectTitle: og7[index]["title"], subjectMarks: og7[index]['marks'].toString(), subjectCode: og7[index]['code'],);
                        };
