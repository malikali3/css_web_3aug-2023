...
class double_tile_subject_pms extends StatelessWidget {
  String subjectTitle;
  String subjectCode;


  double_tile_subject_pms({required this.subjectTitle, required this.subjectCode,}) ;
                                      ...
                                      return
                                        Dialog(
                                          child: Container(
                                            ...
                                            60.sh:
                                            60.sh,
                                            child: years_as_dialog_pms(subjectCode: subjectCodeI, subjectTitle: subjectI,),),);
                                    },
                                  ...
                                  showDialog(context: context, builder: (BuildContext context){
                                    return Dialog(
                                      child: Container(
                                        ...
                                        60.sh:
                                        60.sh,
                                        child: years_as_dialog_pms(subjectCode: subjectCodeII, subjectTitle: subjectII,),),);});
                                },
