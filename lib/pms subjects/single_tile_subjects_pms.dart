...
class singleTileSubjectsPMS extends StatelessWidget {
  final String subjectTitle;
  final String subjectMarks;
  final String subjectCode;
  singleTileSubjectsPMS({required this.subjectTitle, required this.subjectMarks, required this.subjectCode});
                                      ...
                                      Container(
                                        ...
                                        ElevatedButton(
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                Icon(Icons.add_circle_outline_outlined, size: 5.sw, color:  AppConstants().lightGreen,),
                                        ...
                                        ElevatedButton(
                                            ...
                                            Row(
                                              mainAxisAlignment: MainAxisAlignment.center,
                                              children: [
                                                Icon(Icons.remove_circle_outline, size: 5.sw, color: Colors.red,),
